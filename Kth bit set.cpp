...
ll                      i,j,c=0,x=1,y=1,r=0,result=0,ans=1,temp=0,sum=1,a,b,d,n,m,t,k;
...
ll setOrnot(ll n, ll x ){
//First method using left shift
if(n & (1<<(x-1)) !=0 ) 
//that's  why we dont use ==1 beacuse it return 1
cout<<"YES";
else
cout<<"NO";
