...
ll LeftShift(ll n,ll x){
//	LeftShift Opertor
//it shift the binary value of the number by x to left 
//if we assume that leading n bits is 0 then
//result of(n<<x) is equivalent to
/********[x*2^y]*************************************/
cout<<(n<<x);
}
ll RightShift(ll n, ll x){
//result of n>>x is equivalent to ((x)/2^y) 
cout<<(n>>x);
}
int main()
{
